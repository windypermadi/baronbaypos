...
Color colorMenu = const Color(0xff320617);
...
Color secondaryTextColor = const Color(0xffC4C4C4);
Color subtitleColor = const Color(0xff504F5E);
Color transparentColor = Colors.transparent;
Color blackColor = const Color(0xff545454);
Color darkColor = const Color(0xff121214);
